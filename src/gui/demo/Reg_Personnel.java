 ...
 * @author Asus
 */
public class Reg_Personnel extends javax.swing.JFrame {

    /**
     * Creates new form Reg_Personnel
     */
    public Reg_Personnel() {
        initComponents();
    }
                    ...
                    .addGroup(jPanel4Layout.createSequentialGroup()
                        ...
                        .addGroup(jPanel4Layout.createParallelGroup(javax.swing.GroupLayout.Alignment.LEADING)
                            ...
                            .addGroup(jPanel4Layout.createSequentialGroup()
                                ...
                                .addGap(86, 86, 86)
                                .addComponent(txtSirname, javax.swing.GroupLayout.DEFAULT_SIZE, 409, Short.MAX_VALUE))))
                    .addGroup(jPanel4Layout.createSequentialGroup()
    ...
    private void jButton1ActionPerformed(java.awt.event.ActionEvent evt) {//GEN-FIRST:event_jButton1ActionPerformed
       ...
       try{
           ...
           loginpeople_personnel lpp = new loginpeople_personnel();
           lpp.setVisible(true);
           this.dispose();
    ...
    pw.println(txtFname.getText() + ","+ txtSirname.getText()+"," + txtEmail.getText()+"," + txtPhone.getText()+"," + txtNation.getText()+"," + txtCountry.getText()+"," +
            txtCity.getText()+"," + txtDOB.getText()+"," + txtID.getText()+"," + txtPassword.getText());
    ...
    public static void main(String args[]) {
        ...
        try {
            ...
            java.util.logging.Logger.getLogger(Reg_Personnel.class.getName()).log(java.util.logging.Level.SEVERE, null, ex);
        ...
        java.awt.EventQueue.invokeLater(new Runnable() {
            @Override
            public void run() {
                new Reg_Personnel().setVisible(true);
            }
        });
    }
