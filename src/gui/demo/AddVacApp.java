 ...
 * @author Asus
 */
public class AddVacApp extends javax.swing.JFrame {

    /**
     * Creates new form AddVacApp
     */
    public AddVacApp() {
        initComponents();
    }
    ...
    private void initComponents() {
        ...
        jLabel1.setText("Add Vaccination Appointment ");
    ...
    private void jButton3ActionPerformed(java.awt.event.ActionEvent evt) {//GEN-FIRST:event_jButton3ActionPerformed
        ...
        public void SetData() throws IOException{
            ...
            pw.println(txtAppID.getText() + "," + txtTime.getText()+"," + txtDate.getText()+"," + txtAppname.getText()+"," + txtVacname.getText());
    ...
    public static void main(String args[]) {
        ...
        try {
            ...
            java.util.logging.Logger.getLogger(AddVacApp.class.getName()).log(java.util.logging.Level.SEVERE, null, ex);
